...
public class CustomSSLSocketFactory extends SSLSocketFactory {
    ...
    public static HttpClient createSSLHttpClient() {
        try {
            ...
            CustomSSLSocketFactory mSSLSocketFactory = new CustomSSLSocketFactory(trustStore);
            mSSLSocketFactory.setHostnameVerifier(CustomSSLSocketFactory.ALLOW_ALL_HOSTNAME_VERIFIER);
